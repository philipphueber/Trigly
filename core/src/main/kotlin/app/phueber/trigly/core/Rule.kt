 ...
 * collects under "Other" there. Null means "not in a folder". This is
 * deliberately distinct from `""`, which nothing in this codebase should ever
 * store: a blank and a null both mean "no folder", and letting two spellings
 * of that exist would mean some ungrouped rules compare equal to each other
 * and some do not, depending on which boundary they came in through. Every
 * place a folder name
